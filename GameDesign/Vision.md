...
**BARAKI** — мультиплеерная FFA-стратегия в духе Tug of War на **Windows**: экономика и оборона базы, армии сами идут в бой. **2–5** игроков. **Только люди**, без ботов. Запуск из главного меню: справа вкладки **ИГРА** / **ДРУЗЬЯ**; слева профиль и вкладки чат / история / публичные игры / настройки.
