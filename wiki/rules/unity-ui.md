...
**Унифицированные экраны** (graphite dark-fantasy): **Main Menu**, **Lobby**, **RacePick**, **Match HUD** (нижний док: minimap chrome, context strip, inspector, командные кнопки, тултипы). HP-полоски юнитов и контент миникарты — старая палитра.

Пауза и остальной HUD живут в `BarakiTheme.uss` и графитовой палитре не подчиняются, пока их не переделают отдельно.
