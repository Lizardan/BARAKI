...
| 3–5 | `TOPOLOGY_RING` | Сосед ±1 по кольцу | **Напротив** (+ merge в арене; non-zero-sum) |
...
- **5 игроков:** center перегружен **геометрией** (все сходятся в арену); статы те же, что при N=2.
