...
**Унифицированные экраны** (graphite dark-fantasy): **Main Menu**, **Lobby**, **RacePick**.

HUD / пауза живут в `BarakiTheme.uss` и графитовой палитре не подчиняются, пока их не переделают отдельно.
